<?php
	...
	$condição = "tipo_papel in (2)";
	$qpes = $cpessoa->readPessoa($c, $crud, $colunas="id, nome as descricao, cadastro, tipo_papel", $tabela="pessoa", $tipoMetodo=0, $filtro=$condição, $viewsql=0);
