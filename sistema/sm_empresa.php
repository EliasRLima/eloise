	...
	<div class="widget-body">
		<div class="widget-main">
		    ...
		    <div style="width: 100%; height: 450px">
						<h3><b>Busca e edi&ccedil;&atilde;o de empresa por nome:</b></h3>  
		   				 <form name="formNomeBusca" method="POST" action="relatorio_buscar_empresa.php" style="">
								<input type="hidden" name="id" id="id" value="<?=$id?>"/>
								<input style="width:80%;margin:3px;" type="text" name="EmpresaN" id="EmpresaN" placeholder="Digite o nome da empresa ou nome fantasia"></input><input style="width:15%;" class="btn btn-success btn-lg" type="submit" name="button" id="button" value="Buscar"/>
