...
<div class="widget-box">
	...
	<div class="widget-body">
		<div class="widget-main">
			 ...
			 <?php
			  $string = $_POST['EmpresaN'];
			  $link = @mysqli_connect('LocalHost','root','','eloisebd') or die("sem conexao");
				
				//query para buscar estagios
				$query = "select * from pessoa where tipo_papel='2' and nome like '%";
				$query .= $string;
				$query .= "%' or nome_fantasia like '%".$string."%';";
				//echo $query;exit();
				...
				// inicia o loop que vai mostrar todos os dados	
					?>
					<p>
						<h3>Numero de empresas localizadas: <?echo $num_rows;?></h3>
					</p>
					<p>
						<?if($num_rows >30){
					...
					?>
  					<tr>
  						<td>
            				...
            				<?php $url="_id=".$linha['id'];?>
  							<a href="edi_empresa.php?url=<?php echo $inf->doCodifica($url)?>" name="msgdestino"/>
  						...
  						<td><?$cnpj=$linha['cadastro'];if($cnpj==-1){echo "";}else{echo $cnpj;}?></td>
  						<td><?$telefone = str_replace("-1","", $linha['telefones']);$telefone = str_replace("[\"0=>,\",\"1=>","", $telefone);$telefone = str_replace("1:","", $telefone);$telefone = str_replace("2:","", $telefone);$telefone = str_replace("3:","", $telefone);$telefone = str_replace("4:","", $telefone);$telefone = str_replace("\"]","", $telefone);
  						$telefone = str_replace(",\",\"2=>,\"","", $telefone);$telefone = str_replace("\"3=>,\"","", $telefone);$telefone = str_replace("\"4=>","", $telefone);$telefone = str_replace(",,","", $telefone);$telefone = str_replace(",,","", $telefone);$telefone = str_replace(",,","", $telefone);echo $telefone; ?></td>
  						<td><?=$linha['areas_interesse']?></td>
  					</tr>
						<?
						$controlador+=1;
			 ...
			 <div class="row">
					<div class="col-xs-12 col-sm-12">						
						<div class="form-actions center">
							<a href="http://10.10.1.245/eloise/sistema/sm_empresa.php" name="msgdestino"/>
