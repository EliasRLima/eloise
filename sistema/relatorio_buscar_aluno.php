		...
		<div class="widget-main">
			 ...
			 <?php
			  ...
			  $link = @mysqli_connect('LocalHost','root','','eloisebd') or die("sem conexao");
				...
				$query = "select id,nome,sexo,bairro,telefones,data_nascimento,(select descricao from curso where id = pessoa.curso_id)as curso from pessoa where tipo_papel='3' and nome like '%";
				$query .= $string;
				$query .= "%';";
					...
					?>
  					<tr>
  						<td>
							...
							<!--<?php $url="_id=".$linha['id'];?>
  							<a href="gerarDeclaracao.php?url=<?php echo $inf->doCodifica($url)?>" name="msgdestino"/>
								<i class="ace-icon fa fa-bus" style="color: black;"></i>
							</a>
  						...
  						<td><?=$linha['bairro']?></td>
  						<td><?$telefone = str_replace(",-1","", $linha['telefones']);$telefone = str_replace("-1","", $telefone);$telefone = str_replace("[\"0=>,\",\"1=>","", $telefone);$telefone = str_replace("1:","", $telefone);$telefone = str_replace("[\"0=>","", $telefone);$telefone = str_replace("2:","", $telefone);$telefone = str_replace("3:","", $telefone);$telefone = str_replace("4:","", $telefone);$telefone = str_replace("\"]","", $telefone);$telefone = str_replace(",\",\"2=>,\"","", $telefone);$telefone = str_replace("\"3=>,\"","", $telefone);$telefone = str_replace(",\"4=>","", $telefone);$telefone = str_replace(",,","", $telefone);$telefone = str_replace(",,","", $telefone);$telefone = str_replace(",,","", $telefone);echo $telefone; ?></td>	
  						<td><?=$linha['curso']?>		
  					</tr>
						<?
						$controlador+=1;
