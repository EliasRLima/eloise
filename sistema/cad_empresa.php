 ...
 */
	...
	$action = "classes/ins_empresa.php";
	$impar = "#FFFFFF";
	$par = "#CCCCCC";
	$impar = $par;
	$fundo = "#006400";
...
$qsx = $crud->readTipoSituacao($c, $colunas="id, descricao, valor_char", $tabela="pessoa", $chave="sexo", $tipoMetodo=0, $filtro="ativo=1", $orderby="ts.descricao desc", $viewsql=0);
...
<div class="widget-box">
	<div class="widget-header widget-header-small">          
		<h5 class="widget-title lighter"><?php echo "Insira os dados da empresa";?></h5>
	</div>
		...
		<div class="widget-main">
			...
			<form class="form-search" action='<?=$action ?>' method="post"	enctype="multipart/form-data" name="formcadusuario">
				...
				$arInputLabNome = array(
										...
										,"Cadastro de pessoa jur&iacute;dica"=>"cadastro"
										...
										,"Pessoa para contato"=>"pessoa_contato"
										,"Telefones"=>"telefones"
				...
				foreach ($arInputLabNome as $lab=>$nm) {
						...
						if($nm=="dataAtualizacaoCadastro") $ph="DD/MM/AAAA";
