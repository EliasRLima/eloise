 ...
 */
	...
	$cpessoa = new CPessoa(); 	
	$action = "classes/upd_empresa.php";
	$impar = "#FFFFFF";
	$par = "#CCCCCC";
	$impar = $par;
	$fundo = "#006400";
...
//./NOFIFICACAO
	...
	$arInputLabNome = array(
							...
							,"Cadastro de pessoa jur&iacute;dica(CNPJ)"=>"cadastro"
							,"Area de interesse"=>"areas_interesse"
							...
							,"Pessoa para contato"=>"aux_pessoa_id"
		...
		<div class="widget-main">
			...
			<form class="form-search" action='<?=$action ?>' method="post"	enctype="multipart/form-data" name="formcadusuario">
				...
				foreach ($arInputLabNome as $lab=>$nm) {
						...
						if($nm=="data_atualizacao") $ph="DD/MM/AAAA";
				...
				?>
				<input type="hidden" name="data_atualizacao_cadastro" value="<?=$data_atualizacao_cadastro?>"/>
				<input type="hidden" name="tipo_papel" value="2"/>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12">						
						<div class="form-actions center">
							...
							<a href="seletora.php?url=eJyLT8vMKSnKtzXSiS9ILEjNsTUCAD%2FhBms%3D" name="msgdestino"/>
