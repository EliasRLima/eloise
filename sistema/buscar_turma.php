	...
	<div class="widget-body">
		<div class="widget-main" style="margin: 0;border: 0; width:100%;">
			<div style="width:100%;">
		   			...
		   			<div style="height:220px;width: 101%">
							<h3><b>Editar turma:</b></h3>  
		   					<form name="formEstagio" method="POST" action="edi_turma.php">
												<?
												...
												<input style="width:75%;" class="btn btn-success btn-lg" type="submit" name="buscar" id="button_buscar" value="Editar"/>
