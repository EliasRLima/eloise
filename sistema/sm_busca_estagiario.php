 ...
 */
	...
	$colspan ="3";
	$siape = "";
	$descrelatorio="Buscar est&aacute;gio";
	...
	<div class="widget-body">
		<div class="widget-main">
		    ...
		    <div style="width: 100%; height: 450px">
						<h3><b>Busca e edi&ccedil;&atilde;o pelo nome do estagi&aacute;rio:</b></h3>  
		   				 <form name="formNomeBusca" method="POST" action="relatorio_buscar_estagio.php" style="">
								<input type="hidden" name="id" id="id" value="<?=$id?>"/>
								<input style="width:80%;margin:3px;" type="text" name="EstN" id="EstN" placeholder="Digite o nome do aluno"></input><input style="width:15%;" class="btn btn-success btn-lg" type="submit" name="button" id="button" value="Buscar"/>
