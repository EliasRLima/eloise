		...
		<div class="widget-main">
			 ...
			 if (in_array($_SESSION["loginiwe"],$arSA)   ){
			  ...
			  $link = @mysqli_connect('LocalHost','root','','eloisebd') or die("sem conexao");
				...
				$query = "select *,(select descricao from curso where id = pessoa_inativos.curso_id)as curso from pessoa_inativos where nome like '%";
				$query .= $string;
				$query .= "%';";
				//echo $query; exit();
  					...
  					<tr>
  						<td>
            				...
            				<?php $url="_id=".$linha['id'];?>
  							<a href="confirmar_reativar.php?url=<?php echo $inf->doCodifica($url)?>" name="msgdestino"/>
								<i class="ace-icon fa fa-unlock" style="color: black;"></i>
			 ...
			 <div class="row">
					<div class="col-xs-12 col-sm-12">						
						<div class="form-actions center">
							<a href="sm_busca_inativo.php" name="msgdestino"/>
